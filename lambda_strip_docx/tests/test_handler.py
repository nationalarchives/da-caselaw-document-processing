...
class TestLambdaHandler:
    ...
    def test_lambda_handler_does_not_processes_pdf_files_with_image_differences(self, vis_diff_error, s3_with_pdf_file, input_pdf, caplog):
        """Test lambda handler processes files which have annotations which cause image differences post cleaning"""
