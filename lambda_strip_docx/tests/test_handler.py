...
class TestLambdaHandler:
    ...
    def test_dont_process_docx_file_with_comments(self, s3_with_docx_file_with_comments, input_docx_with_comments):
        ...
        with patch("logging.Logger.info") as mock_log_info:
            ...
            mock_log_info.assert_any_call(f"Failed to process file {object_key}")
